...
class network_9layers(nn.Module):
    def __init__(self, num_classes=79077, channel_nums=3):
        super(network_9layers, self).__init__()
        self.features = nn.Sequential(
            mfm(channel_nums, 48, 5, 1, 2), 
...
class network_29layers(nn.Module):
    def __init__(self, block, layers, num_classes=79077, channel_nums=3):
        super(network_29layers, self).__init__()
        self.conv1  = mfm(channel_nums, 48, 5, 1, 2)
